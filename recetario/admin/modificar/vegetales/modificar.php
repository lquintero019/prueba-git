<?php
	...
	$id = $_GET['id'];
	$sql1 = "SELECT nombre, img FROM vegetales WHERE id = $id";
	$rs1 = mysql_query($sql1);
	$row1 = mysql_fetch_assoc($rs1);

	$sql2 = "SELECT num_pasos,ingrediente FROM ingre_proce_vegetales WHERE id_vegetales = $id";
	$rs2 = mysql_query($sql2);

	$sql3 = "SELECT num_pasos,proceso FROM proce_ingre_vegetales WHERE id_vegetal = $id";
...
<body>
	...
	<a href="http://localhost/recetario/admin/modificar/vegetales/vegetales.php"><button class="ui button">Salir</button></a>
	<form name="modificar_receta" method="POST" class="ui form size" action="modificar_receta.php" enctype="multipart/form-data">
		<p></p>
			<div>
				<p>
			...
			<div>
				<p>
					...
					<img class='ui medium rounded image' src="../../../catalog/vegetales/images/<?php echo $row1['img']; ?>" alt="">
				...
				<ul>
					...
					<?php
						while ($row2 = mysql_fetch_assoc($rs2)) {
							...
							?>
							<p>Ingrediente: <label for="Ingrediente"><?php print_r($numPas);?></label></p>
