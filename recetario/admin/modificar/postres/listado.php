...
$sql = "SELECT SQL_CALC_FOUND_ROWS id, nombre, img FROM postres LIMIT $offset, $limit";
         ...
         <?php
            while ($row = mysql_fetch_assoc($rs))
            {
               ...
               <tr>
                  <td><?php echo $id; ?></td>
                  <td><?php echo $name; ?></td>
                  <td><?php echo "<img class='ui medium rounded image' src='../../../catalog/postres/images/".$img."' border='0' width='300' height='100'>"; ?></td>
                  <td>
