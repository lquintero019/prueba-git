<?php
	...
	for ($i=1; $i <= $canIngre; $i++) { 
		$sql="INSERT INTO ingre_proce_bebidas(id_bebida,num_pasos,ingrediente) VALUES('".$id."','".$i."','".$ingrediente[$i]."')";
	...
	for ($x=1; $x <= $canProce; $x++) { 
		$sql2="INSERT INTO proce_ingre_bebidas(id_bebida,num_pasos,proceso) VALUES('".$id."','".$x."','".$proceso[$x]."')";
