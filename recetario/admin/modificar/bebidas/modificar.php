<?php
	...
	$id = $_GET['id'];
	$sql1 = "SELECT nombre, img FROM bebidas WHERE id = $id";
	$rs1 = mysql_query($sql1);
	$row1 = mysql_fetch_assoc($rs1);

	$sql2 = "SELECT num_pasos,ingrediente FROM ingre_proce_bebidas WHERE id_bebida = $id";
	$rs2 = mysql_query($sql2);

	$sql3 = "SELECT num_pasos,proceso FROM proce_ingre_bebidas WHERE id_bebida = $id";
...
<body>
	...
	<a href="http://localhost/recetario/admin/modificar/bebidas/bebidas.php"><button class="ui button">Salir</button></a>
	<p></p>
	<form name="modificar_receta" class="ui form size" method="POST" action="modificar_receta.php" enctype="multipart/form-data">
			...
			<div>
				<p>
					...
					<img class='ui medium rounded image' src="../../../catalog/bebidas/images/<?php echo $row1['img']; ?>" alt="">
