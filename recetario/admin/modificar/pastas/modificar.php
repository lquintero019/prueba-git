<?php
	...
	$id = $_GET['id'];
	$sql1 = "SELECT nombre, img FROM pastas WHERE id = $id";
	$rs1 = mysql_query($sql1);
	$row1 = mysql_fetch_assoc($rs1);

	$sql2 = "SELECT num_pasos,ingrediente FROM ingre_proce_pastas WHERE id_pastas = $id";
	$rs2 = mysql_query($sql2);

	$sql3 = "SELECT num_pasos,proceso FROM proce_ingre_pastas WHERE id_pasta = $id";
...
<body>
	...
	<a href="http://localhost/recetario/admin/modificar/pastas/pastas.php"><button class="ui button">Salir</button></a>
	<p></p>
